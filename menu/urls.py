...
urlpatterns = [
    ...
    path('postres/', views.carta_postres, name='postres'),
    path('infantil/', views.carta_infantil, name='infantil'),
    path('te-cafe/', views.carta_te_cafe, name='te_cafe'),
    path('bebidas/', views.carta_bebidas, name='bebidas'),
    path('llevar/', views.carta_llevar, name='llevar'),
